...
<div class="container">
    ...
    <div class="row" style="margin-bottom: 3em">
        ...
        <div class="product-details col-md-5 offset-md-1 mt-1">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <h3 class="lead">Retail Price: ${{ format($product->price) }}</h3>
                    <h3 class="lead">{{ (!empty($product->member_price)) ? 'Member Price: $' . format($product->member_price) : ''}}</h3>
                    ...
                    @if ($product->quantity > 0)
                        <form action="{{ route('cart.store') }}" method="POST">
                            ...
                            {{-- <button type="submit" class="btn custom-border-n btn-success">Add to Cart</button> --}}
                        </form>
                    @endif
                </div>
