    ...
    <div class="row mb-5">
        <div class="col-md-5 offset-md-1">
            ...
            <form action="{{ route('checkout.store') }}" method="POST">
                ...
                {{-- <div class="form-group">
                    ...
                    @guest
                        <input type="text" name="email" class="form-control my-input" readonly>
                    @else
                        <input type="text" name="email" class="form-control my-input" value="{{ auth()->user()->email }}" readonly readonly>
                    @endguest
                </div> --}}
                <div class="form-group">
                    <label for="name" class="light-text">Name</label>
                    <input type="text" name="name" class="form-control my-input" readonly value="{{ $order->billing_name }}">
                </div>
                <div class="form-group">
                    <label for="address" class="light-text">Address</label>
                    <input type="text" name="address" class="form-control my-input" readonly value="{{ $order->billing_address }}">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="city" class="light-text">City</label>
                            <input type="text" name="city" class="form-control my-input" readonly value="{{ $order->billing_city }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="province" class="light-text">Province</label>
                        <input type="text" name="province" class="form-control my-input" readonly value="{{ $order->billing_province }}">
                    </div>
                </div>
                <div class="row">
                    {{-- <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="postal_code" class="form-control my-input" readonly>
                        </div>
                    </div> --}}
                    <div class="col-md-6">
                        <label for="phone" class="light-text">Phone</label>
                        <input type="text" name="phone" class="form-control my-input" readonly value="{{ $order->billing_phone }}">
                    </div>
                </div>
                {{-- <h2 style="margin-top:1em; margin-bottom:1em;">Payment details</h2>
                <div class="form-group">
                    <label for="name_on_card" class="light-text">Name on card</label>
                    <input type="text" name="name_on_card" class="form-control my-input" readonly>
                </div>
                <div class="form-group">
                    <label for="credit_card" class="light-text">Credit Card</label>
                    <input type="text" name="credit_card" class="form-control my-input" readonly>
                </div> --}}
        ...
        <div class="col-md-5 offset-md-1">
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('shop.show', $item->slug) }}">
                                    <img src="{{ productImage($item->image) }}" height="100px" width="100px"></td>
                                </a>
                            <td>
                            <td>
                                <a href="{{ route('shop.show', $item->slug) }}" class="text-decoration-none">
                                    <h3 class="lead light-text">{{ $item->name }}</h3>
                                    <p class="light-text">{{ $item->details }}</p>
                                    <h3 class="light-text lead text-small">${{ $item->price }}</h3>
                                </a>
                            </td>
                            <td>
            ...
            <div class="row">
                ...
                <div class="col-md-4 offset-md-4">
                    <span class="text-right" style="display: inline-block">${{ format($order->billing_total) }}</span>
                </div>
            </div>
            <hr>
            {{-- @if (!session()->has('coupon'))
                <form action="{{ route('coupon.store') }}" method="POST">
                    ...
                    <input type="text" name="coupon_code" id="coupon" class="form-control my-input" placeholder="123456" readonly>
