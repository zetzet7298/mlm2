...
var KTFormValidationDemoAdvanced = function () {
  ...
  var exampleAdvanced = function exampleAdvanced() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_advanced');
  ...
  var exampleFlatpickr = function exampleFlatpickr() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_flatpickr');
  ...
  var exampleImageInput = function exampleImageInput() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_image_input');
  ...
  var examplePassword = function examplePassword() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_password');
  ...
  var exampleSelect2 = function exampleSelect2() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_select2');
  ...
  var exampleTagify = function exampleTagify() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_tagify');
