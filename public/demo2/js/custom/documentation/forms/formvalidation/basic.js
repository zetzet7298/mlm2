...
var KTFormValidationDemoBasic = function () {
  ...
  var exampleBasic = function exampleBasic() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_basic');
  ...
  var exampleText = function exampleText() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_text');
  ...
  var exampleEmail = function exampleEmail() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_email');
  ...
  var exampleTextarea = function exampleTextarea() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_textarea');
  ...
  var exampleRadio = function exampleRadio() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_radio');
  ...
  var exampleCheckbox = function exampleCheckbox() {
    // Define form element
    var form = document.getElementById('kt_docs_formvalidation_checkbox');
